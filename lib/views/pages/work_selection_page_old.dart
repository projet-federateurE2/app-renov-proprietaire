...
class WorkSelectionPageOld extends StatefulWidget {
  final String workType;

  const WorkSelectionPageOld({Key? key, required this.workType}) : super(key: key);

  @override
  _WorkSelectionPageOldState createState() => _WorkSelectionPageOldState();
}

class _WorkSelectionPageOldState extends State<WorkSelectionPageOld> {
  var workname1 = "hihi";
  var sizeScreen = 0.0;
  var numberColumns;
